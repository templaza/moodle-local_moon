...
class settings
{
    public static function load_options($dir = ''): void
    {
    ...
    public static function prepare_manager_form($settings): array
    {
        $form_content = [];
        ...
        foreach ($settings as $key => $setting) {
            ...
            foreach ($setting['fields'] as $fkey => $field) {
                ...
                $field_tmp  =   [
                    ...
                    'type'          =>  'json',
                    'group'         =>  $fieldset->name,
                    'ngShow'        =>  self::replace_relationship_operators($field['conditions'] ?? ''),
                    'help'          =>  $field['help'] ?? '',
                ];
    ...
    public static function replace_relationship_operators($str): array|string
    {
    ...
    public static function load_language(): array {
