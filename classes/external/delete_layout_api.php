...
class delete_layout_api extends api {
    ...
    public static function execute($theme, $task, $filearea, $itemid, $layouts) {
        $params = self::validate_parameters(self::execute_parameters(), ['theme' => $theme, 'task' => $task, 'filearea' => $filearea, 'itemid' => $itemid, 'layouts' => $layouts]);
