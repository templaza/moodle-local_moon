    ...
    [
        ...
        'fields' => [
            ...
            'sass_overrides' => [
                ...
                'type' => 'sassoverrides',
                'default' => [
                    ['variable' => 'btn-border-radius-lg', 'value' => '0.2rem', 'color' => false],
                    ['variable' => 'btn-padding-y-lg',   'value' => '0.6rem', 'color' => false],
                    ['variable' => 'btn-padding-x-lg',   'value' => '2.5rem', 'color' => false],
                ],
            ],
        ]
    ]
