...
class course_handler {
    public function moon_get_course_details($courseId) {
    ...
    public function moon_get_course_description($courseId, $maxLength){
        global $CFG, $COURSE, $USER, $DB, $SESSION, $SITE, $PAGE, $OUTPUT;
    ...
    public function moon_get_category_details($categoryId){
        global $CFG, $COURSE, $USER, $DB, $SESSION, $SITE, $PAGE, $OUTPUT;
    ...
    public function moon_get_example_categories($maxNum) {
        global $CFG, $DB;
        ...
        $moonReturn[] = $this->moon_get_category_details($moonCategory->id);
        }
        return $moonReturn;
    }

    public function moon_get_example_categories_ids($maxNum) {
        global $CFG, $DB;
    
        $moonCategories = $this->moon_get_example_categories($maxNum);
