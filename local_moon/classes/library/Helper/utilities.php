...
class utilities
{
    ...
    {
        $form_template = array();
        $moonElements = self::get_all_moon_elements($mode);
        foreach ($moonElements as $moonElement) {
            $form_template[$moonElement->type] = $moonElement->render_json('addon');
        }
    ...
    public static function get_moon_scss_variables(): string
    {
        ...
        $content = '';
        if (!empty($variables)) {
            $colorMode =   $template->get_actual_color_mode();
    ...
    public static function typography(): void
    {
        ...
        foreach ($types as $type => $selector) {
            ...
            style::render_typography($selector, $typography, $bodyTypography, true);
        }
    }
    ...
    public static function preloader(): void
    {
        ...
        $document->add_style_declaration($preloaderStyles);
    }

    public static function get_rgba_values(string $rgbaString): ?array
    {
